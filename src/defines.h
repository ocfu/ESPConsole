...
#define FMT_PROMPT_START ESC_ATTR_BOLD "\r"
#define FMT_PROMPT_END   ESC_ATTR_RESET

#define FMT_PROMPT_USER_YN ESC_ATTR_BOLD ESC_TEXT_BRIGHT_WHITE "\r%s [y/n]: " ESC_ATTR_RESET
...
#define SYSLOG_DEFAULT_FACILITY SYSLOG_FACILITY_USER
