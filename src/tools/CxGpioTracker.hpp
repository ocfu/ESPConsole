...
// isr handling
extern volatile uint32_t g_anEdgeCounter[3];
extern volatile uint32_t g_anLastInterruptTime[3];
extern volatile uint32_t g_anDebounceDelay[3]; // debounce time in microseconds (20ms default)
